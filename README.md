...
2. 设计一个简单的聊天室，要求
   ...
   2. 能够选择文字显示颜色后发言
      ...
      **[点击跳转至代码目录](https://github.com/ycfeng666/hsClass2/tree/main/asp/3/classWork/classWork2)**
...
1. 实现个人博客发帖功能
   ...
   **[点击跳转至代码](https://github.com/ycfeng666/hsClass2/tree/main/jq/5/index.html)**
...
1. 编写一个登录页面，使用 Tab 栏实现“账号登录”和“二维码登录”这两种方式的切换，并通过 transition 组件实现切换时的动画效果
   ...
   **[点击跳转至代码](https://github.com/ycfeng666/hsClass2/tree/main/vue/4/1.html)**
